...
public class Car {
    ...
    public static class CarBuilder {
        ...
        public CarBuilder(String addModel, String addColor, double addEngineCapasity, int addPassangerCapasity) {
            this.addModel = addModel;
            this.addColor = addColor;
            this.addEngineCapasity = addEngineCapasity;
            this.addPassangerCapasity = addPassangerCapasity;
    ...
    public static void main(String[] args) {
        Car.CarBuilder car=new CarBuilder("Toyota","Black",1000,4);
